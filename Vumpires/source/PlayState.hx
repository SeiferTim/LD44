...
class PlayState extends FlxTransitionableState
{
	...
	override public function destroy():Void
	{
		...
		map = FlxDestroyUtil.destroy(map);
		txtBalls = FlxDestroyUtil.destroy(txtBalls);
		txtLives = FlxDestroyUtil.destroy(txtLives);
		txtScore = FlxDestroyUtil.destroy(txtScore);
		txtVumps = FlxDestroyUtil.destroy(txtVumps);
		player = FlxDestroyUtil.destroy(player);
		enemies = FlxDestroyUtil.destroy(enemies);
		playerBalls = FlxDestroyUtil.destroy(playerBalls);
		enemyBalls = FlxDestroyUtil.destroy(enemyBalls);
		ballDrops = FlxDestroyUtil.destroy(ballDrops);
